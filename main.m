...
[tgrid_SO, Pe_SO] = master_multimode_JC_driven(angular_freqs_SO, nu0, nmax, J_fluc, J_drive, SO_signal, T_final, T1, T2,0);
[tgrid_SO_no_cavity, Pe_SO_no_cavity] = master_JC_drive_only(nu0, J_fluc*J_drive, SO_signal, [0,T_final],0, T1, T2);
...
[tgrid_COS, Pe_COS] = master_multimode_JC_driven(angular_freqs_SO, nu0, nmax, J_fluc, J_drive, Cos_signal, T_final, T1, T2,0);
[tgrid_COS_no_cavity, Pe_COS_no_cavity] = master_JC_drive_only(nu0, J_fluc*J_drive, Cos_signal, [0,T_final],0 ,T1, T2);
