function [SO_signal, Cos_signal, angular_freqs_SO, angular_freqs_COS] = generate_signals_for_plot_equal_spread(freq_scaling, amp_scaling)
...
amps_COS_unscaled = ones(size(angular_freqs_COS));
