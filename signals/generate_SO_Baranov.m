function [SO_signal, angular_freqs_SO] = generate_SO_Baranov(freq_scaling, amp_scaling, use_gaussian)
%GENERATE_SO_BARANOV Generate the Superoscillating (SO) signal for Baranov method
%
%   [SO_signal, angular_freqs_SO] = generate_SO_Baranov(freq_scaling, amp_scaling, use_gaussian)
%
%   INPUTS:
