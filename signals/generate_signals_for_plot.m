function [SO_signal, Cos_signal,angular_freqs_SO, angular_freqs_COS] = generate_signals_Baranov_2014(freq_scaling,amp_scaling)
...
Cos_signal = @(t)   real(Cos_normalization .* exp(1i * angular_freqs_COS .* t).*exp(-(t-t_0).^2./T^2));
